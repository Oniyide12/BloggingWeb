...
namespace BloggingWeb.Areas.Identity.Pages.Account
{
...
,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.Datejoin= Input.Datejoin;
                user.PhoneNumber = Input.PhoneNumber;

                if (Input.ProfileUrl != null)
                {
                    var filepath= Path.Combine(_webHostEnvironment.WebRootPath,"ProfilePictures",Input.ProfileUrl.FileName);
                    using (var stream= new FileStream(filepath, FileMode.Create))
                    {
                        await Input.ProfileUrl.CopyToAsync(stream);
                        user.ProfileUrl="/ProfilePictures/"+Input.ProfileUrl.FileName;
                    }
